...
function buildDailyCardPrompt(card, birthday, date) {
  ...
  **СТРУКТУРА ОТВЕТА:**
  1. КРАТКОЕ НАПУТСТВИЕ - 1-2 предложения, суть дня
  2. ВЛИЯНИЕ КАРТЫ - как ${card} проявляется в твоей жизни сегодня
  3. ЗОДИАКАЛЬНЫЙ АСПЕКТ - связь с твоим знаком зодиака 
  4. ПРЕДУПРЕЖДЕНИЕ - чего избегать
  5. В добавь мягкое обобщающее послание или совет для дня.
