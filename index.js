...
**ВАЖНО:** Не используй Markup! Избегай шаблонных фраз и общих мест. До 1000 слов. Говори правду, но с заботой. Используй немного эмодзи для передачи эмоций и структуры, но не переусердствуй.
`.trim();
}
