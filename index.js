...
📖 Кратко объясняет каждую карту в контексте вопроса
...
**ВАЖНО:** Избегай шаблонных фраз и общих мест. Будь лаконичным (ответ не более 250-300 слов), проницательным. Говори правду, но с заботой, как мудрый друг. Используй немного эмодзи для передачи эмоций и структуры, но не переусердствуй.
**ВАЖНО:** Форматируй ответ простым текстом без использования разметки Markdown (никаких *, _, ~). Используй эмодзи для выделения разделов.
`.trim();
}
