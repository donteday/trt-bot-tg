...
Без приветствия, создай интерпретацию, которая:
...
**ВАЖНО:** Не используй Markup! Избегай шаблонных фраз и общих мест. Говори правду, но с заботой. Используй немного эмодзи для передачи эмоций и структуры, но не переусердствуй.
`.trim();
}
