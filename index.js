...
**ВАЖНО:** Избегай шаблонных фраз и общих мест. Говори правду, но с заботой, как мудрый друг. Используй немного эмодзи для передачи эмоций и структуры, но не переусердствуй.
`.trim();
}
